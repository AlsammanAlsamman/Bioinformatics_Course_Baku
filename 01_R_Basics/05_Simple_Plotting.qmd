...
To use this, save the content as a file named (for example) `module-1.5-plotting.qmd` and render it using the Quarto CLI (`quarto render module-1.5-plotting.qmd`) or the Render button in RStudio.